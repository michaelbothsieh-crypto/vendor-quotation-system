  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-800 flex flex-col">
      ...
      <main className="flex-1 max-w-4xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-12 flex flex-col items-center">
        ...
        <div className="w-full bg-white rounded-3xl border border-slate-200/80 shadow-md overflow-hidden transition-all duration-300">
          <div className="bg-gradient-to-r from-indigo-50 to-purple-50 px-8 py-6 border-b border-slate-100">
